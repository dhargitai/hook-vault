...
const config = {
  ...
  appDescription:
    "Find the best proven hooks and CTAs for your next video",
  // REQUIRED (no https://, not trialing slash at the end, just the naked domain)
  domainName: "hook-vault.creatigniter.com",
  crisp: {
    // Crisp website ID. IF YOU DON'T USE CRISP: just remove this => Then add a support email in this config file (resend.supportEmail) otherwise customer support won't work.
    id: "",
    // Hide Crisp by default, except on route "/". Crisp is toggled with <ButtonSupport/>. If you want to show Crisp on every routes, just remove this below
    onlyShowOnRoutes: ["/app"],
  },
  stripe: {
  ...
  resend: {
    ...
    fromNoReply: `Project Starter <noreply@resend.project-starter.com>`,
    // REQUIRED — Email 'From' field to be used when sending other emails, like abandoned carts, updates etc..
    fromAdmin: `David at Project Starter <david@resend.project-starter.com>`,
    // Email shown to customer if need support. Leave empty if not needed => if empty, set up Crisp above, otherwise you won't be able to offer customer support."
    supportEmail: "hey@support.project-starter.com",
  },
  colors: {
