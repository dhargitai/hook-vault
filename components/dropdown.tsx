...
export function Dropdown(props: Headless.MenuProps<typeof Button>) {
  return <Headless.Menu {...props} />
}

export function DropdownButton<T extends React.ElementType = 'button'>({ // Default T to 'button' string
  as: Component = 'button' as any, // Cast the default value itself to any
  ...props
}: { className?: string } & Omit<Headless.MenuButtonProps<T>, 'className'>) {
  return <Headless.MenuButton as={Component as any} {...props} />
}
